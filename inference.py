...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='ERDN-Inference')

    parser.add_argument('--save_image', default=False, help='save image if true')
    parser.add_argument('--border', default=False, help='restore border images of video if true')

    parser.add_argument('--data_path', type=str, default='../data/DVD',
                        help='the path of test data')
    parser.add_argument('--model_path', type=str, default='./pretrain_model/model_DVD.pt',
                        help='the path of pretrain model')
    parser.add_argument('--result_path', type=str, default='./infer_results/infer_DVD',
